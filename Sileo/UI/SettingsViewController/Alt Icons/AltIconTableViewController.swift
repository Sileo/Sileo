...
class AltIconTableViewController: UITableViewController {
    ...
    var icons = [
        ...
        AltIcon(displayName: "Cookie", author: "flowerible", key: "Cookie", image: altImage("Cookie")),
        AltIcon(displayName: "Dopamine", author: "flowerible", key: "Dopamine", image: altImage("Dopamine")),
        AltIcon(displayName: "palera1n", author: "flowerible", key: "palera1n", image: altImage("palera1n")),
