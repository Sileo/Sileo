...
class AltIconTableViewController: UITableViewController {
    ...
    var icons = [
        ...
        AltIcon(displayName: "Mixture", author: "Eva Isabella Luna", key: "Mixture", image: altImage("Mixture")),
        AltIcon(displayName: "Midnight", author: "Eva Isabella Luna", key: "Midnight", image: altImage("Midnight")),
