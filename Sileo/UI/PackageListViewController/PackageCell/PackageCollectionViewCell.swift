    ...
    public var targetPackage: Package? {
        didSet {
            if let targetPackage = targetPackage {
                ...
                var deponfw = "\(targetPackage.conflicts ?? "Depends: firmware (>= 0.0)"),"
                ...
                var conflictwithfw = "\(targetPackage.conflicts ?? "Conflicts: firmware (>= 9999999.0)"),"
...
extension PackageCollectionViewCell: SwipeCollectionViewCellDelegate {
    ...
    //thanks to Serena for this
    func doesConflict(confOrDependString: String, forVersion ver: Float) -> Bool {
            if ((!((confOrDependString.contains(", firmware")) || (confOrDependString.contains(",firmware")) || (confOrDependString.contains(": firmware")) || (confOrDependString.contains(":firmware")))) && (!(confOrDependString.contains("firmware")))) {
